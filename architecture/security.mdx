---
title: "Security Groups, IAM Roles, and EC2 Hardening on AWS"
sidebarTitle: "Security"
description: "Three-layer security group design for ALB, Node.js, and MongoDB tiers, with IAM roles and IMDSv2 enforcement for hardened EC2 instances on AWS."
---
...
<CardGroup cols={2}>
  ...
  <Card title="User Data Replace on Change" icon="arrows-rotate">
    ...
    than leaving a running instance with stale bootstrap configuration.
  </Card>
</CardGroup>
