---
title: "network Module: VPC, Subnets, Gateways, and Routes"
sidebarTitle: "network"
description: "Creates the VPC, two public subnets across two AZs, one private subnet, Internet Gateway, NAT Gateway, Elastic IP, and all route tables."
---
