---
title: "keypair Module: Auto-Generated SSH Key Pair for EC2"
sidebarTitle: "keypair"
description: "Generates an RSA 4096-bit SSH key using the TLS provider, saves the private key as a .pem file at keys/, and registers it with AWS EC2."
---
