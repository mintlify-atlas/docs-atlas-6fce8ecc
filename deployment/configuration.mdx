...
description: "Set all required Terraform variables including project name, AWS region, VPC CIDRs, availability zones, instance type, and SSH access IP before deploying."
---
...
allowed_ssh_ip = "YOUR_IP/32" # Run: curl ifconfig.me
```
