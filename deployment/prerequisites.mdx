---
title: "Prerequisites for AWS MEAN Stack Terraform Deployment"
sidebarTitle: "Prerequisites"
description: "Everything you need before running terraform apply: Terraform 1.12+, AWS CLI, an IAM user with required permissions, and an S3 bucket for remote state."
---
